<%-- 
    Document   : integrate
    Created on : Mar 19, 2021, 11:45:02 PM
    Author     : WINDOWS 10
--%>
...
-->
    ...
    <td height="263"><p class="style2">&nbsp;</p>
      ...
      <tr>
        <td height="135"><table width="478" border="0" align="center">
          <tr>
            <td width="143" height="38">Patient Id <span class="style4">*</span> </td>
            <td width="14">&nbsp;</td>
            <td width="307"><label>
          ...
          <tr>
            ...
            <td>&nbsp;</td>
            <td><label>
              <input type="submit" name="s1" value="Submit" style="background-color:#993300; border-bottom-color:#993333;">&nbsp;&nbsp;&nbsp;&nbsp;
              <input type="submit" name="s3" value="Cancel" style="background-color:#993300; border-bottom-color:#993333; ">
            </label></td>
          </tr>
        </table></td>
      </tr>
    </table>
      <p align="center"><%=msg%></p><table width="1201" border="0">
  <tr>
    <td width="1191">&nbsp;</td>
  </tr>
  <tr>
    <td><table width="1091" border="0">
        <tr>
          <td width="1081"><table width="1087" border="1" bgcolor="#CC6600">
            <tr>
        ...
        <tr>
          <td height="41"><table width="1087" border="0">    
            <% 
	try
	{
 ...
 System.out.println(a11);
		...
		ResultSet rs = st.executeQuery("select * from cancer where pid='"+request.getParameter("a1")+"' order by pid asc");
    ...
    while(rs.next())
	 ...
	 %>
            <tr>
              ...
              <td width="27"><%=rs.getString(2)%></td>
              <td width="44"><%=rs.getString(3)%></td>
              <td width="46"><%=rs.getString(4)%></td>
              <td width="51"><%=rs.getString(5)%></td>
              <td width="45"><%=rs.getString(6)%></td>
              <td width="66"><%=rs.getString(7)%></td>
              <td width="39"><%=rs.getString(8)%></td>
              <td width="42"><%=rs.getString(9)%></td>
              <td width="41"><%=rs.getString(10)%></td>
              <td width="43"><%=rs.getString(11)%></td>
              <td width="43"><%=rs.getString(12)%></td>
              <td width="38"><%=rs.getString(13)%></td>
              
              <td width="39"><%=rs.getString(14)%></td>
              <td width="39"><%=rs.getString(15)%></td>
              <td width="43"><%=rs.getString(16)%></td>
              <td width="38"><%=rs.getString(17)%></td>
              <td width="47"><%=rs.getString(18)%></td>
              <td width="48"><%=rs.getString(19)%></td>
              <td width="59"><%=rs.getString(20)%></td>
              <td width="68"><%=rs.getString(21)%></td>
              <td width="47"><%=rs.getString(22)%></td>
              <td width="32"><%=rs.getString(23)%></td>
			  <td width="38"><%=rs.getString(24)%></td>
			    <td width="33"><%=rs.getString(25)%></td>
            </tr> <%
  ...
  <tr>
    <td><table width="1198" border="0">
        <tr>
          <td width="1192"><table width="1193" border="1" bgcolor="#CC6600">
            <tr>
              <td width="246" height="27"><div align="center" class="style9"> Patient ID</div></td>
              <td width="246"><div align="center" class="style9"> Weight </div></td>
              <td width="246"><div align="center" class="style9"> Sugar</div></td>
              <td width="437"><p align="center" class="style9"> Cholestrol </p></td>
 ...
 System.out.println(a11);
		...
		ResultSet rs = st.executeQuery("select * from health where pid='"+request.getParameter("a1")+"'");
    ...
    while(rs.next())
	 ...
	 %>
            <tr>
              <td width="249" height="30"><div align="center"><%=rs.getString(1)%></div></td>
              <td width="246"><div align="center"><%=rs.getString(2)%></div></td>
              <td width="243"><div align="center"><%=rs.getString(3)%></div></td>
              <td width="437"><div align="center"><%=rs.getString(4)%></div></td>
            </tr> <%
